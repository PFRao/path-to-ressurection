...
#Morph differentiation: enhanced senses,
...
def make_map():
	...
	for r in range(MAX_ROOMS):
		...
		if not failed:
			...
			num_rooms += 1
	#make some stairs in the last room
...
def new_game():
	global player, inventory, game_msgs, game_state, dungeon_level, player_level
	#make player
...
def next_level():
	...
	message('You proceed down the dark staircase to the next level.', libtcod.light_green)
	dungeon_level += 1
	make_map()
	initialize_fov()
...
def load_game():
	...
	global map, objects, player, inventory, game_msgs, game_state, stairs, dungeon_level, player_level
